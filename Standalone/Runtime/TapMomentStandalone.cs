    ...
    public class TapMomentStandalone : ITapMomentBridge {
        public void Open(Orientation orientation) {
            ...
            if (config.RegionType == RegionType.CN) {
                url = $"https://www.taptap.cn/app/{config.AppID}/topic?utm_medium=link&utm_source=pc_sdk";
            } else {
                url = $"https://www.taptap.io/app/{config.AppID}?utm_medium=link&utm_source=pc_sdk";
            }
